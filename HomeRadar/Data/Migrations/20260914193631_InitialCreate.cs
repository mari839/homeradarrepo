        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchQueryString = table.Column<string>(type: "TEXT", nullable: false),
                    TelegramChatId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    TelegramLinkCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    LastSeenListingId = table.Column<int>(type: "INTEGER", nullable: true),
                    LastSeenUpdatedAt = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    SearchRequestJson = table.Column<string>(type: "TEXT", nullable: false),
                    TelegramChatId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    TelegramLinkCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    LastSeenApplicationId = table.Column<int>(type: "INTEGER", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    LastCheckedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
